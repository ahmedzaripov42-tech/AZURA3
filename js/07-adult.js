...
// Security Gate + Content Type Filter + WebP/JPG + Gallery Upload
...
function renderAapChapters(container) {
  container.innerHTML = `
    ...
    <div class="aap-chapter-add-card" style="padding:24px;text-align:center;">
      ...
      <div style="font-size:11px;color:var(--adult-text-muted);margin-bottom:18px;">WebP/JPG/JPG · format tanlash · 1-300 ta birdan</div>
        ...
        tile.innerHTML = `
          <div style="background:linear-gradient(135deg,rgba(155,10,26,0.12),rgba(139,26,58,0.08));border:1px solid rgba(155,10,26,0.35);border-radius:12px;padding:16px;display:flex;align-items:center;gap:14px;">
            ...
            <div style="flex:1;">
              ...
              <div style="font-size:10px;color:var(--text-muted);">Kontent turi filtri · WebP/JPG bob qo'shish · Galereya cover upload</div>
            </div>
