...
(function() {
  ...
  function renderContinueReading() {
    ...
    card.innerHTML='<div class="az-cont-grid">'+mws.map(function(mw){
      ...
      var cover=(typeof window.azuraGetOptimizedCoverSrc==='function')?window.azuraGetOptimizedCoverSrc(mw.cover||''):(mw.cover||'');
      return'<div class="az-cont-wrap" onclick="openManhwa(\''+mw.id+'\')">'+
        '<div class="az-cont-cover-wrap"><img class="az-cont-cover" src="'+esc(cover)+'" alt="" loading="lazy" decoding="async"/><div class="az-cont-cover-glow"></div></div>'+
